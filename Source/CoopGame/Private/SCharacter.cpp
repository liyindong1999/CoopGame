...
void ASCharacter::OnHealthChanged(USHealthComponent* HealthComp, float Health, float HealthDelta, 
	const class UDamageType* DamageType, class AController* InstigatedBy, AActor* DamageCauser)//处理角色受到伤害
{
	if (Health <= 0.0f && !bDied)//当角色血量小于0为死亡状态时禁止玩家控制，并且设置其碰撞参数为无碰撞
	{
		bDied = true;
...
void ASCharacter::Tick(float DeltaTime)
{
	...
	float TargetFOV = bWantsToZoom ? fZoomedFOV : DefaultFOV;//当需要放大为真时改变视角范围
