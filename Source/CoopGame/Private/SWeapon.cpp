...
FAutoConsoleVariableRef CVARDebugWeaponDrawing(
	...
	DebugWeaponDrawing,
	TEXT("Drawing Debug Lines for Weapons"),
	ECVF_Cheat);
...
ASWeapon::ASWeapon()
{
	...
	NetUpdateFrequency = 66.0f; //网络更新频率
	MinNetUpdateFrequency = 33.0f;//最小网络更新速率
}
...
void ASWeapon::Fire()
{
	...
	if (MyOwner)
	{
		...
		{
			HitScanTrace.TranceTo = TracerEndPoint;
...
{
	//播放粒子效果
	PlayFireEffect(HitScanTrace.TranceTo);
	PlayImpactEffect(HitScanTrace.SurfaceType, HitScanTrace.TranceTo);
}
...
bool ASWeapon::ServerFire_Validate()//作弊检查
{
	return true;
}
